...
t_token				*new_token(t_tokenlist *tokenlist, char *str, int len,
						bool expand);
int					prep_token(t_tokenlist *tokenlist, char *str, int i,
						int len);
...
int					exp_lexer(t_tokenlist *tokenlist, t_msh_data *msh_data,
						int type, size_t i);
int					expand_var(t_tokenlist **tokenlist, int pos,
						t_msh_data *msh_data, t_token *check_token);
char				*prep_leftover(char *str_token, char *start, int offset);
char				*exp_token(char *str_token, char *start, char *value,
						int offset);
...
int					find_type(t_tokenlist *tokenlist, size_t pos, int red,
						t_token_type type);
int					make_cm_list(t_tokenlist *tokenlist, t_exec_data *comm_list,
						t_pos *ind);
