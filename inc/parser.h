...
int			fill_comm_list(t_exec_data *exec_data, t_tokenlist *tokenlist, size_t pos, int pos_red);
...
int			val_redir(t_tokenlist *tokenlist, size_t i);
...
int			expand_var(t_tokenlist **tokenlist, int pos, t_msh_data *msh_data, t_token *check_token, bool quoted);
int			rm_quotes(t_tokenlist *tokenlist, int pos, char symbol);
int			add_arg_to_list(t_exec_data *comm_list, t_tokenlist *tokenlist, int *i, size_t pos, int pos_red);
int			add_redirect(t_exec_data* execdata, t_tokenlist *tokenlist, int pos, int pos_red);
int			set_heredoc(t_exec_data* execdata, t_tokenlist *tokenlist, int pos, int pos_red);
...
int			convert_data(t_tokenlist *tokenlist, t_msh_data *msh_data, int i, size_t pos, int pos_red);
